...
if (command == 'owner1') {
 let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:WhatsApp; ElainaBot\nNICKNAME:👑 Owner ElainaBot\nORG: Fauzan\nTITLE:soft\nitem1.TEL;waid=6285219759926:+62 852-1975-9926\nitem1.X-ABLabel:📞 Nomor Owner\nitem2.URL:https://instagram.com/fauzan_nauf\nitem2.X-ABLabel:💬 More\nitem3.EMAIL;type=INTERNET: fauzannauf123@gmail.com\nitem3.X-ABLabel:💌 Mail Owner ElainaBot\nitem4.ADR:;;🇮🇩 Indonesia;;;;\nitem4.X-ABADR:💬 More\nitem4.X-ABLabel:📍 Lokasi Saya\nBDAY;value=date:🔖 ,12 Juli 2010\nEND:VCARD`
...
handler.tags = ['info']
handler.command = /^(owner1|ownerbot)$/i

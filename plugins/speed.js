...
let fliveLoc22 = {
            ...
            message: { "liveLocationMessage": { "title": packname,"h": bottime, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
await conn.send3ButtonDoc(m.chat, runtt, botdate, 'Owner', '.owner', 'Menu', '.Menu','Credit','.credit', fliveLoc22, {
			contextInfo: {
